...
console.log(
  `"jason jason jason smith" .replace('jason', "kevin"): ${string2.replace(
    "jason",
    "kevin"
  )}`
); // returns a new string, replaces only the first match, is case sensitive
console.log(
  `"jason jason jason smith" .replace('/JASON/i', "kevin"): ${string2.replace(
    /JASON/i,
    "kevin"
  )}`
); // case insensitive
console.log(
  `"jason jason jason smith" .replace('/jason/g', "kevin"): ${string2.replace(
    /jason/g,
    "kevin"
  )}`
); // applies the replacement globally, matching every word in the string.
...
console.log(
  `"jason jason jason smith".indexOf("jason") = ${string2.indexOf("jason")}`
);

// .lastIndexOf() method returns the index of the last occurrence of a specified text in a string
console.log(
  `"jason jason jason smith".lastIndexOf("jason") = ${string2.lastIndexOf(
    "jason"
  )}`
);
...
console.log(
  `"jason jason jason smith".search("jason") = ${string2.search("jason")}`
);
console.log(
  `"jason jason jason smith".search("smith") = ${string2.search("smith")}`
);
...
console.log(
  `"jason smith".startsWith("jason") = ${string.startsWith("jason")}`
); // returns boolean if he string ends with given character
